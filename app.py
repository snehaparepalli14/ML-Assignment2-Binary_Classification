...
if uploaded_file is not None:
    ...
    # -----------------------------
    # Download Predictions (FULL DATA)
    # -----------------------------
    ...
    if st.button("Compare All Models"):
        ...
        st.markdown("""
        **Observations:**
        - Ensemble models typically demonstrate stronger AUC performance.
        - Logistic Regression provides stable and interpretable baseline results.
        - Models with higher AUC indicate better class separation ability.
